...
\begin{DoxyCompactList}\small\item\em The application entry point. This is where everything is initialised. \end{DoxyCompactList}\item 
...
The main function initialises all peripherals and starts up the program by taking user input and initialising the hardware before handing over the control to the Free\+RTOS scheduler.
